...
import { createGeminiClient, GeminiClient } from '../src/llm/gemini.js';
import { calculateBackoffDelay, isRetryableError, sleep, withRetry } from '../src/llm/retry.js';
import {
...
describe('Step 3: Network Resilience & Retry Logic', () => {
  test('calculateBackoffDelay should increase exponentially and respect cap', () => {
    ...
    const delayCapped = calculateBackoffDelay(5, {
      initialDelayMs: 100,
      maxDelayMs: 500,
      jitterMs: 0,
    });
          ...
          content: {
            parts: [
              { text: 'Kode berhasil dibuat.' },
              {
                functionCall: {
                  name: 'write_file',
                  args: { filePath: 'test.js', content: 'console.log(1);' },
                },
              },
            ],
          },
